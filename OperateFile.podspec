#
#  Be sure to run `pod spec lint OperateFile.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "pinping"
  # s.authors            = { "pinping" => "377795496@163.com" }
  # s.social_media_url   = "http://twitter.com/pinping"
  ...
  s.source_files  = "OperateFile", "OperateFile/*.{h,m}"
